                    ...
                    if(place_count == 1){
                        ...
                        for(p = 0; p < places.length; p++){
                            if(places[p].name && places[p].name != 0){
                                ...
                                rtn = rtn + "<div style='padding: 5px 5px 0 10px;'> - <a href='javascript:;' onclick=\"jQuery('#" + location_id + "').val('" + places[p].name + "');\" style='text-decoration:none;'>" + places[p].name + "</a></div>";
                            }
                        }
