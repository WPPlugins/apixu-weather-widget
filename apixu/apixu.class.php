...
class apixuWeather
{
	const API_RORECAST = 'http://api.apixu.com/v1/forecast.json';
	const API_CURRENT = 'http://api.apixu.com/v1/current.json';
	const API_SEARCH = 'http://api.apixu.com/v1/search.json';
	private static $key = "";
